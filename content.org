...
Clojure, and utilize the power of computer technology.
...
| Raise Sexp                 |       ctrl+alt+p  ctrl+alt+r        | ctrl+opt+p  ctrl+opt+r  |
| Drag sexp forward/backward |           alt+up/down arrows        | opt+up/down arrows      |
